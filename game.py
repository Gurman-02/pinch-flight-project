...
G = 0.3
SPEEDFLY = -4
BIRDIMG = pygame.image.load('img/girl3.png')
...
DISTANCE = 300
COLUMNSPEED = 1
COLUMNIMG = pygame.image.load('img/c2.jpg')

BACKGROUND = pygame.image.load('img/bg1.jpeg')
...
pygame.display.set_caption("PINCH-FLIGHT ADVENTURES")
...
def gameStart(bird):
    ...
    headingSuface = font.render("LET'S FLY", True, (0, 0, 128))
